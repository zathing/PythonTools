...
def parse_line(line_content):
	...
	#check if the string ends with line number
	if not util.is_end_with_line_num(line_content):
		print line_content
		print '[end_with_line_num check] fail,return emtpy'
		return {}
...
if __name__ == '__main__':
	...
	#'22/03/2018 14:34:10.542 1930:076c @@@ <TmSystemChecking> *** TmSystemChecking.dll was loaded as process attach. - TmSystemChecking.cpp(57)'
	#parse_line(line_content)
